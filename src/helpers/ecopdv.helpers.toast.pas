...
{$ENDIF}
begin
  FAnimation := TFloatPropertyAnimation.Create(FOwner);
...
{$IFDEF ANDROID}
  if TPlatformServices.Current.SupportsPlatformService
    (IFMXVirtualKeyboardService, IInterface(LService)) then
...
begin
  ...
  FFrame.Name := FFrame.ClassName + MilliSecondOf(Now).ToString +
